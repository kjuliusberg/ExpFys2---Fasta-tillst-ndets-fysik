...
\end{equation}
där $\vec G$ är den reciproka gittervektorn, $\vec r$ är ortsvektorn för samtliga atomer i enhetscellen, och $f_j$ är respektive atoms formfaktor. Beroende på den kristallstruktur som bestrålas kommer specifika $hkl$ ge en strukturfaktor som är identisk lika med 0, vilket korresponderar till en förbjuden reflex och inte ger konstruktiv interferens. 
Olika kristallstrukturer medför olika tillåtna och förbjudna reflexer. Exempelvis gäller för koppar, med gitterparameter $a=3,61$ Å, och en FCC-struktur att $h,k,l$ alla måste vara udda jämna\cite{Hofmann}.  
